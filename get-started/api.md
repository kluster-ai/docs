...
The time frame within which the Batch should be processed. Currently, we support 1, 3, 6, 12, and 24 hour completion windows to suit a range of use cases and budget requirements. In the code samples, we use **24h**. For more information on pricing, refer to the [pricing](https://www.kluster.ai/#pricing).
