...
| **Magistral Small** | Reasoning<br>Natural language generation<br>open-ended text creation<br>contextually rich writing. | :white_check_mark: | :white_check_mark: | :x: | :x: |
...
| **Mistral Small** | Fast conversational agents<br>local inference on consumer hardware<br>domain-specific applications<br>and low-latency function calling. | :white_check_mark: | :white_check_mark: | :x: | :x: |
