...
A [Reliability response object](#reliability-response-object) indicating if hallucination was detected.
...
`true` if the answer contains unreliable or unsupported information.
