...
??? child "Show properties"
    ...
    `logit_bias` ++"map"++ <span class="future" markdown>++"future enhancement"++</span>
    ...
    `logprobs` ++"boolean or null"++ <span class="future" markdown>++"future enhancement"++</span>
    ...
    `top_logprobs` ++"integer or null"++ <span class="future" markdown>++"future enhancement"++</span>
