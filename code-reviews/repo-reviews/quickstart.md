...
!!! tip "Prefer terminal workflows?"
    You can also run repo reviews from CLI with `kluster review repo start` and inspect results with `kluster review repo show`. See [Repo reviews from CLI](/code-reviews/repo-reviews/cli/).
...
- **[Repo reviews from CLI](/code-reviews/repo-reviews/cli/)**: Trigger and inspect repo reviews from the terminal.
