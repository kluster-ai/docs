...
4. After the credentials are validated, a confirmation banner shows the Azure DevOps integration with the **Installed** status and confirms that it is ready to review your pull requests automatically.
