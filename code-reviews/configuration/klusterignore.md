...
categories: Basics, Configuration
---
...
|---|---|---|
| IDE | On-demand reviews (human-written code) | [On-demand reviews](/code-reviews/ide-reviews/human-written-code/on-demand-reviews/) |
| IDE | Automatic reviews (human-written code) | [Automatic reviews](/code-reviews/ide-reviews/human-written-code/automatic-reviews/) |
...
- **[On-demand reviews](/code-reviews/ide-reviews/human-written-code/on-demand-reviews/)**: Run manual reviews in your IDE and verify changes on your terms.
- **[Automatic reviews](/code-reviews/ide-reviews/human-written-code/automatic-reviews/)**: Enable automatic reviews that trigger after you stop typing.
