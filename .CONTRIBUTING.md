...
- [Optimizing for SEO](#search-engine-optimization-seo)
...
This example would result in adding 'Build Apps' as a section with two files inside, `index.md` and `kluster-api.md`, and one additional subdirectory named `toolkit`.
...
4. Once you commit and push all of your changes, open a pull request for the new content branch against the `main` branch
