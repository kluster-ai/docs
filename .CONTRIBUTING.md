...
- **[kluster.ai MkDocs](https://github.com/papermoonio/kluster.ai-docs)** - contains the MkDocs config files, theme overrides, and custom CSS for the kluster.ai documentation site
...
1. Clone this repository:
    ...
    ```bash
    git clone https://github.com/papermoonio/kluster.ai-mkdocs
    ```

2. Inside the folder just created, clone the `docs` repository:

    ```bash
    cd kluster.ai-mkdocs
...
2. In the kluster.ai-mkdocs folder (which should be the current one), you can build the site by running:
